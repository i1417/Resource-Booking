...
var employeePendingRequestPage = angular.module('employeePendingRequestsApp', ['ui-notification', 'ngRoute', 'dataShareFactory', 'utilityFunctionsFactory', 'topbarApp', 'sidebarApp','ui.bootstrap']);

// Controller to Cancel the user's pending requests
employeePendingRequestPage.controller('employeePendingRequestCtrl', function($scope, $http, userDetails, utilityFunctions, $location, Notification) {
